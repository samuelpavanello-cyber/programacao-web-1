...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="password"] { 
            width: 100%; padding: 15px; margin: 10px 0; border: 1px solid #ccc; border-radius: 8px; font-size: 16px;
        }
        .erro { color: red; font-weight: bold; margin: 10px 0; }
        small { color: #666; }
    </style>
</head>
<body>
    ...
    <p style="text-align:center; margin:50px 0 20px;">
        <a href="../index.php" style="color:#27ae60; font-weight:bold; text-decoration:none; border-bottom:1px dashed #27ae60;">
